        ...
        <Card className="w-full max-w-2xl">
          <CardContent className="pt-6">
            <div className="text-center space-y-6">
              ...
              {/* Возможные причины */}
              <div className="bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 rounded-lg p-6 text-left">
                <h3 className="font-semibold text-red-900 dark:text-red-100 mb-3">Возможные причины:</h3>
              ...
              <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-6 text-left">
                <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-3">Что делать дальше:</h3>
